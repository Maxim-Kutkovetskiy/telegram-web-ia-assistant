...
[Демонстрация](#️-демонстрация) • [Возможности](#-возможности) • [Быстрый старт](#-быстрый-старт) • [Установка](#-установка) • [Деплой](#️-деплой-на-сервер) • [Архитектура](#️-архитектура)
...
- [Деплой на сервер](#️-деплой-на-сервер)
...
Стартовое меню бота с кнопками «Быстрая запись» и «Консультация»
